...
const FormGroupInfo = (props) => {
    ...
    const handleClickFormIconClose = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // useEffect(() => {
        //     if (props.formGroupIsOpen) props.toggleFormGroup(false)
        ...
        <div className={props.className}>
            <form className="form-group-info">
                <div className="icon-close">
                    <MdOutlineClose onClick={handleClickFormIconClose}/>
                </div>
                <h3>GROUP INFO</h3>
                <FromGroup>
...
const mapDispathToProps = (dispatch, props) => {
    return {
        ...
        createGroup: (groupItem)=>{
            dispatch(userActions.createGroup(groupItem))
        },
